...
The name is inspired by the character Gem in the film *Tron: Legacy*. Gem is under development — the current build is a single-user MVP, and [What Gem Does Today](#-what-gem-does-today) shows the current status.
